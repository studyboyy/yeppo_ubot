...
class Bot(Client):
    def __init__(self, **kwargs):
        super().__init__(**kwargs, device_model="NEZABOT")
...
from NEZABOT.core.database import *
from NEZABOT.core.function import *
from NEZABOT.core.helpers import *
from NEZABOT.core.plugins import *